...
$myItem->addExtra(1, 'Sour Cream', 0.51);
$myItem->addExtra(2, 'Cheese', 0.32);
$myItem->addExtra(3, 'Guacamole', 0.63);
$myItem->addExtra(4, 'Salsa', 0.84);
//out go to bag of food items
$items[] = $myItem;

$myItem = new Item(2, 'Hot Dog', 'Our hot dogs are awesome', 5.95, 20);
$myItem->addExtra(1, 'Ketchup', 0.75);
$myItem->addExtra(2, 'Onions', 0.36);
$myItem->addExtra(3, 'Spicy mustard', 0.97);
$myItem->addExtra(4, 'Saurkraut', 0.58);
$items[] = $myItem;

$myItem = new Item(3, 'Sundae', 'Our sundaes are awesome', 3.95, 25);
$myItem->addExtra(1, 'Chocolate', 1.39);
$myItem->addExtra(2, 'Nuts', 2.17);
$myItem->addExtra(3, 'Whipped cream', 3.25);
$myItem->addExtra(4, 'Cherry', 1.73);
$items[] = $myItem;
